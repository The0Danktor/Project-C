      ...
      <div className="flex flex-col items-center w-full">
        <div className="flex flex-col gap-14 h-screen p-20">
          ...
          <ul className="flex flex-col gap-8 overflow-y-auto items-center border-2 border-gray-100 dark:border-gray-800 p-10 rounded-xl">
            ...
            <Machine machineName="Machine 4" tekenNumber="4" type="4" onclick={() => buttonClick("/machineproblems")}/>
            <Machine machineName="Machine 5" tekenNumber="5" type="5" onclick={() => buttonClick("/machineproblems")}/>
            <Machine machineName="Machine 6" tekenNumber="6" type="6" onclick={() => buttonClick("/machineproblems")}/>
            <Machine machineName="Machine 7" tekenNumber="7" type="7" onclick={() => buttonClick("/machineproblems")}/>
            <Machine machineName="Machine 8" tekenNumber="8" type="8" onclick={() => buttonClick("/machineproblems")}/>
            <Machine machineName="Machine 9" tekenNumber="9" type="9" onclick={() => buttonClick("/machineproblems")}/>
            <Machine machineName="Machine 10" tekenNumber="10" type="10" onclick={() => buttonClick("/machineproblems")}/>
          </ul>
        </div>
      </div>
    </div>
