...
export function Dropdown(props: information) {
  ...
  return (
    <div className="md:w-72 mb-3 w-full">
      <Listbox value={selectedValue} onChange={setSelected}>
        <div className="relative mt-1">
          ...
          py-2 pl-3 pr-10 text-left shadow-sm focus:outline-none focus-visible:border-gray-300 focus-visible:ring-2 
          focus-visible:ring-white dark:focus-visible:ring-gray-900 focus-visible:ring-opacity-75 focus-visible:ring-offset-2 
          focus-visible:ring-offset-gray-300 dark:focus-visible:ring-offset-white md:text-sm"
          >
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="z-10 absolute mt-1 max-h-60 w-full overflow-auto rounded-sm bg-white py-1 text-base shadow-lg !ring-1 
            ring-black !ring-opacity-5 focus:outline-none md:text-sm dark:bg-gray-700 dark:ring-white">
