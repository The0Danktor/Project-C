    ...
    <div className="flex bg-white dark:bg-gray-900 transition duration-300">
      ...
      <div>
        ...
        <div className="flex font-semibold text-black dark:text-gray-400 transition duration-300">
          ...
          <div className="flex flex-col items-center  mt-20 mx-10 w-60 h-40 font-semibold bg-white text-black dark:hover:text-white dark:text-gray-400 dark:bg-gray-900 hover:bg-slate-100 dark:hover:bg-gray-800 dark:shadow-gray-600 shadow-lg rounded-lg transition duration-300">
            <p>Number of Problems</p>
            <h1 className="m-12 font-semibold text-2xl text-black dark:text-gray-400">
              22
            </h1>
          </div>
        </div>
