...
export function Button(props: information) {
  return (
    <button
      className=" dark:bg-gray-800 bg-gray-200 md:w-40 block rounded dark:hover:bg-gray-900 hover:bg-gray-200
...
export function ButtonAdmin(props: AdminInformation) {
  return (
    ...
    dark:text-gray-400 rounded-lg text-2xl py-2 mt-5 lg:mt-0 grow min-w-[15rem] flex-1"
    >
      <p className="mt-2">{props.title}</p>
      <h1 className="m-6 mb-4 xl:mb-4 font-semibold text-5xl text-black dark:text-gray-400">
        {props.bar}
      </h1>
    </Link>
  );
