...
export function Header() {
  return (
    <div className="flex flex-col w-full h-24  bg-white dark:bg-gray-900 border-b-2 border-gray-100 dark:border-gray-800 transition duration-300">
      <div className="flex flex-row h-24 text-2xl items-center justify-center font-medium dark:text-gray-400 text-black transition duration-300">
        Logged in as: Admin
      </div>
      <div className="flex transition justify-end mr-3 duration-300 text-black dark:text-gray-400 ">
