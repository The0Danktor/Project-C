  ...
  return (
    <div className="absolute left-0 h-screen w-80 flex flex-col bg-white dark:bg-gray-900 border-r-2 border-gray-200 dark:border-gray-800 transition duration-300" >
      ...
      <div className="flex flex-col item">
        <p className="dark:text-white mx-4 my-2 transition duration-300">Home</p>
        <p className="dark:text-white mx-4 my-2 transition duration-300">Tickets</p>
        <p className="dark:text-white mx-4 my-2 transition duration-300">KnowledgeBase</p>
        <p className="dark:text-white mx-4 my-2 transition duration-300">Admin</p>
        <p className="dark:text-white mx-4 my-2 transition duration-300">Settings</p>
      </div>
    </div>
  );
}
